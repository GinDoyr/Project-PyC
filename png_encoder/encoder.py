# MOST OF THE FOLLOWING CODE IS TAKEN FROM shankarnarayank/steganography/utils/encode.py ! all credits for the orig funcs to them, i only edited very small parts!
...
def ncode(msg2hide, img_name, result_image_name="encoded.png", password=None):
    try:
...
if __name__ == '__main__':
    with open('settings.ini', 'r') as f:
        main_msg = f.read()
        print(main_msg)
    ncode(main_msg, "Jill.png", "ITWORKS.png")